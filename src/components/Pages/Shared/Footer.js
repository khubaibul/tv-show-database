...
const Footer = () => {
  return (
    <footer className="bg-cover bg-center bg-no-repeat bg-gray-800 text-gray-200 bg-gradient-to-r from-[#03223B] via-[#02223C] to-[#032541]">
      <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8 flex flex-col justify-center items-center">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 footer-bg-transparent p-2 rounded-lg">
          <div className="flex flex-col items-center sm:items-center lg:items-start lg:flex-none">
            <img src={videoProduction} className="mr-5 w-28" alt="logo" />
            <div className="flex mt-8 space-x-6 text-gray-600">
              ...
              >
                ...
                <svg
                  className="w-6 h-6 hover:animate-pulse rounded-full"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                  aria-hidden="true"
                >
          ...
          <div className="grid grid-cols-2 gap-8 lg:col-span-2 sm:grid-cols-4 lg:grid-cols-4 md:grid-cols-4">
            <div>
              <p className="font-bold font-playFair text-primary">THE BASICS</p>
              <nav className="flex flex-col mt-4 space-y-2 text-sm text-slate-300">
                <Link to="/about" className="text-primary/50" href>
                  {" "}
                  About TSDB{" "}
                </Link>
                <Link className="text-primary/50" href>
                  {" "}
                  Contact Us{" "}
                </Link>
                <Link className="text-primary/50" href>
            ...
            <div>
              <p className="font-bold font-playFair text-primary">COMMUNITY</p>
              <nav className="flex flex-col mt-4 space-y-2 text-sm text-slate-300">
                <Link className="text-primary/50" href>
                  {" "}
                  Guidelines{" "}
                </Link>
                <Link to="/faq" className="text-primary/50" href>
                  {" "}
                  Discussions{" "}
                </Link>
                <Link className="text-primary/50" href>
            ...
            <div>
              <p className="font-bold font-playFair text-primary">LEGAL</p>
              <nav className="flex flex-col mt-4 space-y-2 text-sm text-slate-300">
                <Link className="text-primary/50" href>
                  {" "}
                  Privacy Policy{" "}
